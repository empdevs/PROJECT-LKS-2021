	...
	<div class="main d-flex justify-content-center align-items-center">
		<div class="container">
			...
			<div class="judul-menu text-center">
				<h3>Peta Situs Covid 19</h3>
			</div>
			<div class="konten d-flex flex-wrap justify-content-center bg-white">
				<div class="peta">
					<img src="images/peta1.jpg" style=" width: 100%; height: 150px; margin-right: 5px;">
				</div>
				<div class="peta">
					<img src="images/peta2.png" style=" width: 100%; height: 150px; margin-right: 5px;">
				</div>
				<div class="peta">
					<img src="images/peta3.jpg" style="  width: 100%; height: 150px; margin-right: 5px;">
				</div>
			</div>
