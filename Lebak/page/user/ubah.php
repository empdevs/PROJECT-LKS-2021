<?php 
	...
	if(isset($_POST["ubah"])){
			...
			mysqli_query($koneksi,"UPDATE user SET nama_depan='$nama_depan',nama_keluarga='$nama_keluarga',nik='$nik',umur='$umur',telepon='$telepon',email='$email',alamat='$alamat',kota='$kota',provinsi='$provinsi',role='$role' WHERE user_id = '$user_id'");

			echo "<script>
				alert('Data berhasil diubah');
				document.location.href='my_profile.php?page=user&action=detail&user_id=$user_id';
			</script>";
	}
 ?>
